...
This project is part of ASP.NET Core. You can find projects, documentation and getting started instructions for ASP.NET Core at the [Home](https://github.com/aspnet/home) repo.
...
## To run the project on Mac/Mono:
...
**NOTE:** Since on Mono SQL client is not available the project uses an InMemoryStore to run the application. So the changes that you make will not be persisted.
